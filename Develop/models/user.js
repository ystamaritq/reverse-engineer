/**
 * Requiring bcrypt for password hashing. Using the
 * bcryptjs version as the regular bcrypt module
...
module.exports = function (sequelize, DataTypes) {
	 ...
	 * the user can be compared to the
	 ...
	 * phases of the User Model lifecycle. In this case, before
